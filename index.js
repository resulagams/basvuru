...
client.user.setActivity(`♥ Phaelis`)
...
num = num+1
await mr.send(config.sorular[num] ? "<@"+user.id+"> "+Number(num+1)+" Soru: "+config.sorular[num] : "**Soruları Cevapladığın İçin Teşekkürler, Bütün Sorular Bitti. Başvurun Yönetim Ekibine İletildi Artık Beklemen Gerekli!**").catch(async e => {})
